...
export class GeolocationService {
  ...
  getPolHosp(detail,page){
    ...
    var contentString = '<h4 class="name_infowindow">'+detail.name+'</h4><span class="address_infowindow">'+detail.vicinity+'</span>';
    if (detail.photos!==undefined) {
      var place_ph = detail.photos[0].getUrl({'maxWidth': 300, 'maxHeight': 300});
      contentString=contentString+'<br/><img src="'+place_ph+'" class="img_infowindow"/>';
    }
