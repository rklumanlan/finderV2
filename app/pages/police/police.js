...
export class PolicePage {
  ...
  displayDetails(ctr){
    ...
    me.geolocationService.setPlaceDetails('map',item.place_id).then(function (res) {
      ...
      me.nav.push(PoliceDetailsPage, {item_select_police:me.results});
    });
  ...
  setPoliceRating(){
    var me = this;
    console.log('setPoliceRating');
    setTimeout(function() {

      var x = document.getElementsByClassName("police_rating");
      var y = document.getElementsByClassName("police_hours");
