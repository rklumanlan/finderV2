import {Page,NavParams, Storage, SqlStorage,IonicApp,NavController,ViewController} from 'ionic-angular';
...
export class JeepMapsPage {
  static get parameters(){
    return [[DataService],[NavParams],[ConnectivityService],[IonicApp],[GoogleMapsService],[NavController],[ViewController],[Http]];
  }
  constructor(dataService,navParams,connectivityService,app,googleMapsService,nav,view,http){

    this.view = view;
        // Just log out the index
        console.log(this.view.index);
    this.nav = nav;
    console.log('nav'+this.nav.isTransitioning());
  ...
  initMap(options){
    ...
    let opti = { enableHighAccuracy: true};
    ...
    navigator.geolocation.getCurrentPosition(
        ...
        divRow2.appendChild(divCol2);
            ...
            // var centerControl = me.setColorCode(centerControlDiv, this.map,this.latlng1.color,this.latlng1.name);

            colorCodeDiv.index = 1;
            this.map.controls[google.maps.ControlPosition.TOP_CENTER].push(colorCodeDiv);
    ...
    .subscribe(
      data => {
        ...
        me.drawSnappedPolyline(this.snappedCoordinates1,'jeep1');
          ...
          console.log('default');
          console.log(this.snappedCoordinates1);
...
//
  ...
  drawSnappedPolyline(snappedCoords,ctr) {
    ...
    if(ctr =='jeep1'){
      ...
      me.snappedPolyline1.setMap(this.map);
      console.log(me.snappedPolyline1);
