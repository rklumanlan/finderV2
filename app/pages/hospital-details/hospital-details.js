...
export class HospitalDetailsPage {
  ...
  constructor(navParams,nav,geolocationService) {
    ...
    this.item_select_hospital = this.navParams.get('item_select_hosp');
  ...
  //     me.results = res[0];
  //
  //     if (me.item_select_hospital.reviews!==undefined) {
  //       me.reviews = me.item_select_hospital.reviews;
  //       me.setHospitalReviewRating();
  //     }
  //
  //     if (me.item_select_hospital.photos!==undefined) {
  //       for (var i = 0; i < me.item_select_hospital.photos.length; i++) {
  //         me.photos.push(me.item_select_hospital.photos[i].getUrl({'maxWidth': 300, 'maxHeight': 300}));
  //       }
  //       console.log(me.photos);
  //     }
  //     else {
  //       me.photos.push(me.item_select_hospital.icon);
  //     }
  //
  //     me.contact = me.item_select_hospital.international_phone_number;
  //     me.insertPlaceContact();
  //
  //     me.website = me.item_select_hospital.website;
  //     me.insertWebURL();
  //
  //   });
  // }
  ...
  ionViewLoaded(){
    ...
    // setTimeout(function() {
      ...
      // for (var a = 0; a < me.item_select_hospital.rating.length; a++) {
        //rating number
